    ...
    <div id="navigation-block">
        <nav class="navbar navbar-light navbar-expand-md">
            <div class="container-fluid">
                <a class="navbar-brand" style="font-family: Bungee, cursive;color: rgb(17,127,207);" href="index.php">
                    <img class="img-fluid" src="assets/img/Horizon-Health2.png" style="width: 100%;min-width: 60px;" /></a>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <?php } else { ?>
                        <?php } ?>
                        <?php if (isset($_SESSION['admin']) && ($_SESSION['full'])) { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form id="resetform" class="form-horizontal" role="form" method="POST" action="">
                                ...
                                <input type="submit" name="reset_btn" value="Reset Password" class="btn btn-primary btn-block text-white btn-user">
                            </form>
                        </div>
                    </div>
                </div>
