...
$errorMessage = $users->registerStaff();
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Staff Register - Health Horizon</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Create a Staff Account!</h4>
                            </div>
                            <form id="staffform" class="form-horizontal" role="form" method="POST" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><label>Date of Birth</label>
                                        <!-- Start: Dob --><input class="form-control form-control-user" id="dob" placeholder="Date Of Birth" name="dob" type="date">
                                        <!-- End: Dob -->
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><label>Full Inquiry View</label>
                                        <div class="form-control form-control-user">
                                            <!-- Start: txtSurname --> <input type="checkbox" id="fullaccess" name="fullaccess" value="1"> <label>View All Department Inquiries</label>
                                            <!-- End: txtSurname -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="submit" name="staff_btn" value="Register Account" class="btn btn-primary btn-block text-white btn-user">
                                <hr>
                            </form>
                        </div>
                    </div>
