...
<head>
    ...
    <title>Hospital Register - Horizon Health</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Create Hospital Account!</h4>
                            </div>
                            <form id="registerform" class="form-horizontal" role="form" method="POST" action="">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><label>Hospital Name</label>
                                        <!-- Start: txtFirstName --><input class="form-control form-control-user" type="text" id="firstname" placeholder="Hospital Name" name="firstname">
                                        <!-- End: txtFirstName -->
                                    </div>
                                    <div class="col-sm-6"><label>Hospital Category</label>
                                        <!-- Start: txtSecond -->
                                        <select id="Surname" name="surname" class="form-control" placeholder="Hospital Category...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><label>Register Date</label>
                                        <!-- Start: Register date --><input class="form-control form-control-user" id="dob" placeholder="registerdate" name="dob" type="date">
                                        <!-- End: Register date -->
                                    </div>
                                </div>
                                <div class="form-group row">
